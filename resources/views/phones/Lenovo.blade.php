...
<head>
    ...
    <link rel="stylesheet" href="{{ asset("build\assets\lenovo.css") }}">
                ...
                <div class="services-grid">
                    ...
                    <div class="service-item">
                        ...
                        <div class="service-item-title">
                            <a href="{{ url("/phones/models/lenovoVibeK5") }}" class="flx col-4 center v-center"><h5 class="button home-button button-clear">Lenovo Vibe K5</h5></a>
                    ...
                    <div class="service-item">
                        ...
                        <div class="service-item-title">
                            <a href="{{ url("/phones/models/lenovoVibeX") }}" class="flx col-4 center v-center"><h5 class="button home-button button-clear">Lenovo Vibe X</h5></a>
                        </div>                   
                    </div>
                    <!-- ITEM THREE -->
                    <div class="service-item">
                        ...
                        <div class="service-item-title">
                            <a href="{{ url("/phones/models/lenovoA7000") }}" class="flx col-4 center v-center"><h5 class="button home-button button-clear">Lenovo A7000</h5></a>
                            <div class="selected"></div>
                    ...
                    <div class="service-item">
                        ...
                        <div class="service-item-title">
                            <a href="{{ url("/phones/models/lenovoA820") }}" class="flx col-4 center v-center"><h5 class="button home-button button-clear">Lenovo A820</h5></a>
                        </div>                   
                    </div>
