            ...
            <section class="services hardware-services">
                ...
                <div class="services-grid">
                    ...
                    <div class="service-item">
                        ...
                        <div class="service-item-title">
                            <a href="{{ url("phones/models/iphone14pro") }}" class="flx col-4 center v-center"><h5 class="button home-button button-clear">Iphone 14 Pro</h5></a>
                        </div>                   
                    </div>
                    <!-- ITEM THREE -->
                    <div class="service-item">
                        ...
                        <div class="service-item-title">
                            <a href="{{ url("/phones/models/iphoneSE2gen") }}" class="flx col-4 center v-center"><h5 class="button home-button button-clear">Iphone SE 2.gen</h5></a>
                            <div class="selected"></div>
                    ...
                    <div class="service-item">
                        ...
                        <div class="service-item-title">
                            <a href="{{ url("/phones/models/iphoneSE3gen") }}" class="flx col-4 center v-center"><h5 class="button home-button button-clear">Iphone SE 3.gen</h5></a>
                        </div>                   
                    </div>
