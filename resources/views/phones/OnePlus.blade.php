...
<head>
    ...
    <link rel="stylesheet" href="{{ asset("build\assets\oneplus.css") }}">
                ...
                <div class="services-grid">
                    ...
                    <div class="service-item">
                        ...
                        <div class="service-item-title">
                            <a href="{{ url("/phones/models/OnePlus10Pro") }}" class="flx col-4 center v-center"><h5 class="button home-button button-clear">OnePlus 10 Pro</h5></a>
                    ...
                    <div class="service-item">
                        ...
                        <div class="service-item-title">
                            <a href="{{ url("/phones/models/OnePlus10T") }}" class="flx col-4 center v-center"><h5 class="button home-button button-clear">OnePlus 10 T</h5></a>
                        </div>                   
                    </div>
                    <!-- ITEM THREE -->
                    <div class="service-item">
                        ...
                        <div class="service-item-title">
                            <a href="{{ url("/phones/models/OnePlus9") }}" class="flx col-4 center v-center"><h5 class="button home-button button-clear">OnePlus 9</h5></a>
                            <div class="selected"></div>
