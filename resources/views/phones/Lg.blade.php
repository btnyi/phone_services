...
<head>
    ...
    <link rel="stylesheet" href="{{ asset("build\assets\lg.css") }}">
                ...
                <div class="services-grid">
                    ...
                    <div class="service-item">
                        ...
                        <div class="service-item-title">
                            <a href="{{ url("/phones/models/lgK50S") }}" class="flx col-4 center v-center"><h5 class="button home-button button-clear">LG K50 S</h5></a>
                    ...
                    <div class="service-item">
                        ...
                        <div class="service-item-title">
                            <a href="{{ url("/phones/models/lgG5") }}" class="flx col-4 center v-center"><h5 class="button home-button button-clear">LG G5</h5></a>
                        </div>                   
                    </div>
                    <!-- ITEM THREE -->
                    <div class="service-item">
                        ...
                        <div class="service-item-title">
                            <a href="{{ url("/phones/models/lgG6") }}" class="flx col-4 center v-center"><h5 class="button home-button button-clear">LG G6</h5></a>
                            <div class="selected"></div>
