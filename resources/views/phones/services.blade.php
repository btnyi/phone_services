        ...
        <div class="services-grid">
            @foreach ($brands as $brand)
             <div class="service-item">
                <div>
                <img id="brand-image" src="{{ asset("images/brands/" . $brand->brand_image) }}" alt="{{ $brand->brand_name }}">
                </div>
                <div class="service-item-title">
                <a href="{{ url("phones/" . strtolower($brand->brand_name)) }}" class="flx col-4 center v-center">
                        <h5 class="button home-button button-clear">{{ $brand->brand_name }}</h5>
                    </a>
