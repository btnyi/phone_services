...
<head>
    ...
    <link rel="stylesheet" href="{{ asset("build\assets\pixel.css") }}">
                ...
                <div class="services-grid">
                    ...
                    <div class="service-item">
                        ...
                        <div class="service-item-title">
                            <a href="{{ url("/phones/models/pixel3XL") }}" class="flx col-4 center v-center"><h5 class="button home-button button-clear">Pixel 3 XL</h5></a>
                    ...
                    <div class="service-item">
                        ...
                        <div class="service-item-title">
                            <a href="{{ url("/phones/models/pixel3A") }}" class="flx col-4 center v-center"><h5 class="button home-button button-clear">Pixel 3 A</h5></a>
                        </div>                   
                    </div>
                    <!-- ITEM THREE -->
                    <div class="service-item">
                        ...
                        <div class="service-item-title">
                            <a href="{{ url("/phones/models/pixel4XL") }}" class="flx col-4 center v-center"><h5 class="button home-button button-clear">Pixel 4 XL</h5></a>
                            <div class="selected"></div>
                    ...
                    <div class="service-item">
                        ...
                        <div class="service-item-title">
                            <a href="{{ url("/phones/models/pixel4A") }}" class="flx col-4 center v-center"><h5 class="button home-button button-clear">Pixel 4 A</h5></a>
                        </div>                   
                    </div>
