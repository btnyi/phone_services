...
<head>
    ...
    <link rel="stylesheet" href="{{ asset("build\assets\samsung.css") }}">
                ...
                <div class="services-grid">
                    ...
                    <div class="service-item">
                        ...
                        <div class="service-item-title">
                            <a href="{{ url("/phones/models/samsungGalaxyA54") }}" class="flx col-4 center v-center"><h5 class="button home-button button-clear">Samsung Galaxy A54</h5></a>
                    ...
                    <div class="service-item">
                        ...
                        <div class="service-item-title">
                            <a href="{{ url("/phones/models/samsungGalaxyA34") }}" class="flx col-4 center v-center"><h5 class="button home-button button-clear">Samsung Galaxy A34</h5></a>
                        </div>                   
                    </div>
                    <!-- ITEM THREE -->
                    <div class="service-item">
                        ...
                        <div class="service-item-title">
                            <a href="{{ url("/phones/models/samsungGalaxyS21") }}" class="flx col-4 center v-center"><h5 class="button home-button button-clear">Samsung Galaxy S21</h5></a>
                            <div class="selected"></div>
                    ...
                    <div class="service-item">
                        ...
                        <div class="service-item-title">
                            <a href="{{ url("/phones/models/samsungGalaxyS21Ultra") }}" class="flx col-4 center v-center"><h5 class="button home-button button-clear">Samsung Galaxy S21 Ultra</h5></a>
                        </div>                   
                    </div>
