...
<head>
    ...
    <link rel="stylesheet" href="{{ asset("build/assets/nokia.css") }}">
                ...
                <div class="services-grid">
                    ...
                    <div class="service-item">
                        ...
                        <div class="service-item-title">
                            <a href="{{ url("/phones/models/nokia51Plus") }}" class="flx col-4 center v-center"><h5 class="button home-button button-clear">Nokia 5.1 Plus</h5></a>
                    ...
                    <div class="service-item">
                        ...
                        <div class="service-item-title">
                            <a href="{{ url("/phones/models/nokia61Plus") }}" class="flx col-4 center v-center"><h5 class="button home-button button-clear">Nokia 6.1 Plus</h5></a>
                        </div>                   
                    </div>              
                </div>
            </section>
